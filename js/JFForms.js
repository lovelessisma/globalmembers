(function(a){a.fn.JFforms=function(){};
	...
	a(".custom-select").each(function(b){
		...
		var g=new Array;a(c).children("option").each(function(){
			var b=a(this).text();
			var c=a(this).attr("value");
			g.push('<li data-value="' + c + '">'+b+"</li>")
		});
		f+=g.join("")+"</ul></div></div>";
		a(c).after(f);
		var h=a("li",a("#"+d+"JFElement"));
		h.on("click",function(){
			var b=h.index(this);a("option:selected",e).removeAttr("selected");
			var c=a("option","#"+d);
			...
			window.location = 'index.php?lang=' + $(this).attr('data-value');
		})
	});
