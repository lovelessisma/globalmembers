...
(function (b) {
  b.MetroMessageBox = function (v, a) {
    ...
    if (isIE8orlower() == 0) {
      ...
      i.setAttribute("src", "scripts/metro-alert/sound/messagebox.mp3");
      b.get();
    ...
    u += "<p class='pText fg-white'>" + v.content + "</p>";
    u += t;
...
(function (b) {
  b.MetroLoading = function (i, h) {
    ...
    if (i.special == true) {
      ...
      j += "<p class='pText fg-white animated fadeIn'>" + i.content + "</p>"
    }
    j += l;
    j += "</div>";
    j += "</div>";
...
(function (b) {
  b.bigBox = function (a, h) {
    ...
    if (isIE8orlower() == 0) {
      var i = document.createElement("audio");
      i.setAttribute("src", "scripts/metro-alert/sound/bigbox.mp3");
      b.get();
      i.addEventListener("load", function () {
        i.play()
      }, true);
    ...
    BigBoxes = BigBoxes + 1;
    k = "<div id='bigBox" + BigBoxes + "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" + BigBoxes + "'><img class='botClose' id='botClose" + BigBoxes + "' src='scripts/metro-alert/img/close.png'>";
    k += "<span>" + a.title + "</span>";
    k += "<p>" + a.content + "</p>";
    k += "<div class='bigboxicon'>";
    if (a.img == undefined) {
      a.img = "scripts/metro-alert/img/cloud.png"
    }
    k += "<img src='" + a.img + "'>";
    k += "</div>";
...
(function (b) {
  b.smallBox = function (o, j) {
    ...
    if (isIE8orlower() == 0) {
      ...
      k.setAttribute("src", "scripts/metro-alert/sound/smallbox.mp3");
      b.get();
