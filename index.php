...
$counterIdioma = 0;
$rowIdioma = $idioma->Listar('L');
$countRowIdioma	 = count($rowIdioma);
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" href="js/metro-alert/css/MetroNotificationStyle.css" media="screen"/>
							...
							<div class="rowX">
								<div class="grid_3 columns">
									...
									<select class="custom-select" id="select-1">
										...
										$default = '';
		                                if ($countRowIdioma > 0):
		                                    for ($counterIdioma=0; $counterIdioma < $countRowIdioma; $counterIdioma++):
		                                    	if ($rowIdioma[$counterIdioma]['tm_simbolo'] == $lang):
		                                    		$default = 'selected="selected" ';
		                                    	else:
		                                    		$default = '';
		                                    	endif;
		                                ?>
		                                <option <?php echo $default; ?>value="<?php echo $rowIdioma[$counterIdioma]['tm_simbolo']; ?>"><?php echo $rowIdioma[$counterIdioma]['tm_nombre']; ?></option>
		                                <?php
		                                    endfor;
		                                endif;
		                                ?>
		...
		<div class="banner">
			<ul>
				<li style="background-image: url('images/bg-all.jpg');">
					...
					<a class="btn" href="members/login.php?lang=<?php echo $lang; ?>"><?php $translate->__('Ingrese a la zona de miembros'); ?></a>
				</li>
				...
				<li style="background-image: url('images/shop.jpg');">
					...
					<p><?php $translate->__('Solo requieres internet, pero qu&eacute empresa que se aprecie hoy no lo tiene'); ?></p>
			...
			<div class="container">
				<div class="row Fresh">
					<div class="col-md-4 Des">
						...
						<h4><?php $translate->__('Dise&nacute;o fresco y limpio'); ?></h4>
						<p><?php $translate->__('El dise&nacute;o de nuestras aplicaciones ofrece una experiencia de usuario realmente agradable y funcional.'); ?></p>
					</div>
					...
					<div class="col-md-4 Fully">
						...
						<p><?php $translate->__('Pantallas adaptadas a cualquier resoluci&oacute;n de cualquier dispositivo'); ?></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 bar ">
						...
						<div class="textP">
							<h3>CSS3</h3>
							<p><?php $translate->__('Un esti&aacute;ndar para dise&nacute;os web de calidad.'); ?></p>
						</div>
					</div>
					<div class="col-md-3 bar ">
					...
					<div class="row about">
						...
						<div class="col-md-6">
							...
							<img class="pic2Ab" src="images/picAbout/aboutP2.png">
								...
								<p><?php $translate->__('Esto es posible, ya que nuestras aplicaciones est&aacute;n distribuidas solo en nuestros servidores web, facilitando su administraci&oacute;n.'); ?></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row about">
						<div class="col-md-6">
							...
							<img class="pic1Ab" src="images/picAbout/aboutP3.png">
								...
								<p><?php $translate->__('Todas las actualizaciones de los aplicativos ser&aacute;n peri&oacute;dicas y con cronogramas coordinados con los Miembros Administradores.'); ?></p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="about2">
							<img class="pic2Ab" src="images/picAbout/aboutP4.png">
								...
								<p><?php $translate->__('Si recomiendas nuestros aplicativos, puedes tener gananacias por cada recomendaci&oacute;n de 10% de la venta.'); ?></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="portfolio_block columns3 pretty" data-animated="fadeIn">	
						...
						<div class="element col-sm-4 gall restora">
							...
							<div class="view project_descr center">
								<h3><a href="#"><?php $translate->__('RESTORA - M&oacute;dulo de art&iacute;culos'); ?></a></h3>
								<ul>
						...
						<div class="element col-sm-4 gall restora">
							...
							<div class="view project_descr">
								<h3><a href="#"><?php $translate->__('RESTORA - M&oacute;dulo de ventas'); ?></a></h3>
								<ul>
			...
			<div class="container">
				<div class="row news">
					<div class="col-md-6  text-left">
						...
						<h3><a href="#"><?php $translate->__('Constituye tu empresa en 72 horas en l&iacute;nea.'); ?></a></h3>
						<ul>
						...
						<p><?php $translate->__('El Servicio de Constituci&oacute;n de Empresas en L&iacute;nea (en 72 horas) est&aacute; a tu disposici&oacute;n en Internet. A trav&eacute;s de &eacute;l, podr&aacute;s tener acceso a la informaci&oacute;n y procedimientos necesarios para poder constituir tu empresa o sociedad, de manera particular y en tan s&oacute;lo 3 d&iacute;as.'); ?><a class="readMore" href="http://www.crecemype.pe/portal/index.php/aprovecha-la-ley-mype/constituye-tu-empresa-en-72-horas-en-linea"> <?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
					<div class="col-md-6 text-right">
						...
						<p><?php $translate->__('Si bien nadie est&aacute; libre del estr&eacute;s, son aquellos a cargo de empresas m&aacute;s peque&nacute;as quienes sufren m&aacute;s. Pese a ello, hasta quienes no son expertos en gesti&oacute;n y finanzas consiguen administrar un negocio de forma agradable. Pero se deben seguir ciertas reglas.'); ?><a class="readMore" href="http://mba.americaeconomia.com/articulos/notas/6-pasos-para-administrar-su-negocio-sin-estresarse"><?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
				</div>
			</div>
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
						...
						<h3><a href="#"><?php $translate->__('Consejos pr&aacute;cticos sobre administraci&oacute;n del consultorio odontol&oacute;gico privado.'); ?></a></h3>
						<ul>
							<li><i class="fa fa-calendar"></i><?php $translate->__('Agosto'); ?> 29, 2014</li>
							<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
							<li><a href="#"><i class="fa fa-comments"></i>17 <?php $translate->__('Comentarios'); ?></a></li>
						</ul>
						<p><?php $translate->__('El &eacute;xito profesional depende principalmente de 2 aspectos: En 1º t&eacute;rmino, el nivel de odontolog&iacute;a ofrecida y en 2º t&eacute;rmino, cada vez se hace m&aacute;s imprescindible complementar lo anterior con un correcto gerenciamiento del consultorio.'); ?><a class="readMore" href="http://www.costosenodontologia.com.ar/costosyaranceles/consejos_consultorio.html"><?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
					<div class="col-md-6 text-right">
						<img class="img-responsive picsGall" src="images/picNews/administrar-constructora.jpg"/>
						<h3><a href="#"><?php $translate->__('C&oacute;mo Iniciar una Empresa Constructora o de Construccion con &eacute;xito.'); ?></a></h3>
						<ul>
							<li><i class="fa fa-calendar"></i><?php $translate->__('Agosto'); ?> 30, 2014</li>
							<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
							<li><a href="#"><i class="fa fa-comments"></i>17 <?php $translate->__('Comentarios'); ?></a></li>
						</ul>
						<p><?php $translate->__('Actualmente mucha gente, como usted ha so&nacute;ado de iniciar sus propias empresas de la construcci&oacute;n.'); ?><a class="readMore" href="http://www.emprendices.co/como-iniciar-una-empresa-constructora-o-de-construccion-con-exito/"><?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
				</div>
			</div>
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
						...
						<p><?php $translate->__('El Notario es un profesional del Derecho que ejerce una funci&oacute;n p&uacute;blica para robustecer, con una presunci&oacute;n de verdad, los actos en que interviene, para colaborar en la formaci&oacute;n correcta del negocio jur&iacute;dico y para solemnizar y dar forma legal a los negocios jur&iacute;dicos.'); ?><a class="readMore" href="http://juridirectorio.com/funciones-de-un-notario-publico/"><?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
					<div class="col-md-6 text-right">
						<img class="img-responsive picsGall" src="images/picNews/administrar-gimnasio.jpg"/>
						<h3><a href="#"><?php $translate->__('C&oacute;mo administrar un gimnasio'); ?></a></h3>
						<ul>
			...
			<div class="container hideObj2" style="display:none;">
				<div class="row news2 news">
					<div class="col-md-6 text-right">
						...
						<h3><a href="#"><?php $translate->__('Alta gerencia educativa: C&oacute;mo dirigir y administrar con eficiencia'); ?></a></h3>
						<ul>
							<li><i class="fa fa-calendar"></i>Septiembre 02, 2014</li>
							<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
							<li><a href="#"><i class="fa fa-comments"></i>17 <?php $translate->__('Comentarios'); ?></a></li>
						</ul>
						<p><?php $translate->__('Es importante indicar que el tema se basa en la gesti&oacute;n de todo tipo de centro de estudio.'); ?><a class="readMore" href="http://www.monografias.com/trabajos26/gerencia-educativa/gerencia-educativa.shtml"><?php $translate->__('Leer m&aacute;s'); ?> <i class="fa fa-angle-right"></i></a></p>
						<hr class="hrNews"/>
					</div>
					<div class="col-md-6 text-left">
						<img class="img-responsive picsGall" src="images/picNews/Marketing-Digital.jpg"/>
						<h3 ><a href="#"><?php $translate->__('C&oacute;mo Hacer Publicidad Efectiva Para Tu PYME'); ?></a></h3>
						<ul>
	...
	<div id="contact">
    	<div class="line5">					
			<div class="container">
				<div class="row Ama">
					<div class="col-md-12">
						<h3><?php $translate->__('Tienes una pregunta, estamos aqu&iacute; para ayudarle'); ?></h3>
				...
				<div class="row">
					<div class="col-md-9 col-xs-12 forma">
						<form action="formulario.php" method="post" id="forma1">
							<input type="text" class="col-md-6 col-xs-12 name" id="nombre" name='nombre' placeholder='<?php $translate->__('Nombre *'); ?> '/>
							...
							<div class="cBtn col-xs-12">
								<ul>
									<li class="clear" id="btnClear"><a href="#"><i class="fa fa-times"></i><?php $translate->__('Limpiar'); ?></a></li>
									<li class="send" id="btnSend"><a href="#"><i class="fa fa-share"></i><?php $translate->__('Enviar'); ?></a></li>
								</ul>
							</div>
						</form>
					</div>
					<div class="col-md-3 col-xs-12 cont">
						<ul>
							...
							<li><a href="mailto:info@globalmembers.net"><i class="fa fa-envelope"></i>info@globalmembers.net</a></li>
							<li><i class="fa fa-skype"></i>Globalmembers</li>
							<li><a href="https://twitter.com/GlobalMembers"><i class="fa fa-twitter"></i>Twitter</a></li>
							<li><a href="https://www.facebook.com/globalmemberssac?ref=hl"><i class="fa fa-facebook-square"></i>Facebook</a></li>
							<li><a href="https://www.youtube.com/channel/UCju2H0109UmQGI9RDbn0K1g"><i class="fa fa-youtube-play"></i>YouTube</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="line7">
			<div class="container">
				<div class="row footer">
					<div class="col-md-12">
						<h3><?php $translate->__('Suscr&iacute;bete con nosotros'); ?></h3>
						<p><?php $translate->__('Suscr&iacute;bete con nosotros e ingresa a una comunidad virtual que te har&aacute; la vida m&aacute;s f&aacute;cil!'); ?></p>
						<div class="fr">
							<div style="display: inline-block;">
								<input class="col-md-6 fEmail" name='Email' placeholder='<?php $translate->__('Ingrese su correo'); ?>'/>
								<a href="#" class="subS"><?php $translate->__('Subscr&iacute;bete!'); ?></a>
							</div>
						</div>
					</div>
...
https://www.facebook.com/globalmemberssac?ref=hl" target="_blank"></a></li>
							<li class="soc5"><a href="https://twitter.com/GlobalMembers" target="_blank"></a></li>
							<li class="soc6"><a href="https://www.youtube.com/channel/UCju2H0109UmQGI9RDbn0K1g" target="_blank"></a></li>
							<li class="soc7"><a href="https://plus.google.com/u/0/114395985360181070147/posts" target="_blank"></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<script src="js/metro-alert/js/MetroNotification.js"></script>
	<script type="text/javascript">
		...
		function EnvioEmail () {
			$.ajax({
	            ...
	            success: function(data){
	                ...
	                var titleMessage = '';
	                if (data.estadoEnvio == '00')
	                	titleMessage = 'Mensaje enviado';
	                else
	                	titleMessage = 'Mensaje no enviado';

                    MessageBox('Mensaje enviado', data.detalleLog, "[Aceptar]", function () {
                        $('#forma1')[0].reset();
                        $('#nombre').focus();
                    });
	            }
